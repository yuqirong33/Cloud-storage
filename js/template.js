...
var template  = {
	...
	treeMenuTemplate : function(data,id){
		...
		childs.forEach(function(item){
			...
			html += `
				<li>
					<div class="title ${classNames}" style="padding-left:${level*10}px;" data-file-id="${item.id}">
	...
	//文件夹模板视图模式,childs:表示当前文件下的所有一级子目录
		...
		function htmls(obj){
			var html = `
				...
				<div class="details">
					...
					<p class="timer"><span>${obj.timer}</span></p>
				</div>
			`;
			return html;
		}
